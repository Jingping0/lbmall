    ...
    <div class="row">
        <div class="container">
            <div class="container-title">
                <label class="title">Add New Staff</label>
            </div>

            <form method="post" action="{{ route('admin.createStaffPost') }}"  enctype="multipart/form-data">
                @csrf
                <div class="user-details">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="position" name="position">
                            <option value="#" selected disabled>Select the Position</option>
