    ...
    <div class="row">
        <div class="container">
            <div class="container-title">
                <label class="title">Add New Customer</label>
            </div>

            <form method="post" action="{{ route('admin.createCustomerPost') }}"  enctype="multipart/form-data">
                @csrf
                <div class="user-details">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="input-field" type="number" id="phone" name="phone"  value="{{ old('phone') }}"/>
                        @error('phone')
                            <div class="error-message">{{ $message }}</div>
                        @enderror
                    </div>
