...
<div class="container">
    <div class="row">
        <div class="container">
            ...
            <form method="post" action="{{ route('admin.createUserPost') }}"enctype="multipart/form-data">
                @csrf
                <div class="user-details">
                    <div class="mb-3">
                        <label class="form-label">Username</label>
                        <input class="input-field" type="text" id="username" name="username" value="{{ old('username') }}"/>
                        @error('username')
            ...
            <script>
                ...
                function toggle(){
                    if(state){
                        ...
                        document.getElementById("eye").setAttribute("class","icon-show-password fa fa-eye")
                        state = false;
                    }
                    else{
                        document.getElementById("password").setAttribute("type","text");
                        document.getElementById("eye").setAttribute("class","icon-show-password fa fa-eye-slash")
                        state = true;
                    }
                }
            </script>
